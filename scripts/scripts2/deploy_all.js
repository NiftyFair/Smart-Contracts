...
async function main(network) {
  ...
  console.log(
    'NiftyBundleMarketplace deployed to:',
  ...
  await nft.deployed();
  console.log('NiftyNFTTradable deployed to:', nft.address);
  ...
  console.log('NiftyNFTTradablePrivate deployed to:', nftPrivate.address);
  ////////
  ...
  const priceFeed = await PriceFeed.deploy(NIFTYFAIR_ADDRESS_REGISTRY, PAY_TOKEN);
  ...
  console.log('NiftyArtTradable deployed to:', artTradable.address);
  ...
  console.log(
    'NiftyArtTradablePrivate deployed to:',
  ...
  console.log('NiftyArtFactory deployed to:', artFactory.address);
  ...
  console.log('NiftyArtFactoryPrivate deployed to:', artFactoryPrivate.address);
  ////////
