...
import "./NiftyArtTradablePrivate.sol";

contract NiftyArtFactoryPrivate is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new NiftyArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        NiftyArtTradablePrivate nft = new NiftyArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing NiftyArtTradable contract
    ...
    /// @notice Method for disabling existing NiftyArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
