...
/**
 * @title NiftyArtTradablePrivate
 * NiftyArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract NiftyArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // NiftyFair Marketplace contract
    address marketplace;
    // NiftyFair Bundle Marketplace contract
    ...
    function mint(
        ...
        // Send FfundsTM fee to fee recipient
    ...
    {
        // Whitelist NiftyFair marketplace, bundle marketplace contracts for easy trading.
