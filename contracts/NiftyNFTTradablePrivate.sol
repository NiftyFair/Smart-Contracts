...
/**
 * @title NiftyNFTTradablePrivate
 * NiftyNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract NiftyNFTTradablePrivate is ERC721URIStorage, Ownable {
