...
import "./NiftyNFTTradablePrivate.sol";

contract NiftyNFTFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice NiftyFair auction contract address;
    address public auction;

    /// @notice NiftyFair marketplace contract address;
    address public marketplace;

    /// @notice NiftyFair bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new NiftyNFTTradable contract
        ...
        returns (address)
    {
        ...
        NiftyNFTTradablePrivate nft = new NiftyNFTTradablePrivate(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering existing NiftyNFTTradable contract
    ...
    /// @notice Method for disabling existing NiftyNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
