...
import "./NiftyArtTradable.sol";

contract NiftyArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new NiftyArtTradable contract
        ...
        returns (address)
    {
        ...
        NiftyArtTradable nft = new NiftyArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
