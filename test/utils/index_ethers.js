...
const mockPayTokenMintAmount = new BigNumber.from('2000000000000000000000'); // Sets test accounts to 2000 WXDAI

// Set MockERC721 variables
const mockNFTokenName = 'Test NFT';
const mockNFTokenSymbol = 'NFT';

// Set user `seller` and `bidder` variables for `NiftyAuction`
const sellerReservePrice = new BigNumber.from('100000000000000000000'); // 100 WXDAI
const sellerNewReservePrice = new BigNumber.from('50000000000000000000'); // 50 WXDAI
const bidderBidAmountMinimum = new BigNumber.from('25000000000000000000'); // 25 WXDAI
